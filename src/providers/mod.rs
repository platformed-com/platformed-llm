...
/// Standard base64 (RFC 4648) encode with padding. The hosted providers
/// carry inline file bytes as base64 in their wire formats (OpenAI
/// data-URLs, Gemini `inlineData.data`, Anthropic `source.data`);
/// [`crate::FileSource::Bytes`] holds raw bytes, so each provider encodes
/// here.
#[cfg(any(feature = "openai", feature = "google", feature = "anthropic-vertex"))]
