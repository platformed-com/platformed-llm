...
use platformed_llm::{
    CompleteResponse, Error, FinishReason, FunctionCall, OutputItem, Prompt, Role, Usage,
};

#[test]
fn test_prompt_builder() {
    let prompt =
        Prompt::system("You are a helpful assistant").with_user("What is the capital of France?");
    ...
    let original_prompt = Prompt::system("You are a helpful assistant").with_user("Hello world");
